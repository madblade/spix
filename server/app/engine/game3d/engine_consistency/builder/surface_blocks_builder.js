...
class CSBX {
    ...
    static extractSurfaceBlocks(chunk)
    {
        ...
        let addSurfaceBlock = function(bid, sbs) {
        ...
        for (let b = 0; b < capacity; ++b) {
            if (blocks[b] !== 0) {
                ...
                // Access other chunk
                } else if (neighbourBlocks[0][iPlus - iSize] === 0) {
                    addSurfaceBlock(b, currentSbs);
                    continue;
                }
                ...
                // Access other chunk
                } else if (neighbourBlocks[1][iMinus + iSize] === 0) {
                    addSurfaceBlock(b, currentSbs);
                    continue;
                }
                ...
                // Access other chunk
                } else  if (neighbourBlocks[2][jPlus - ijSize] === 0) {
                    addSurfaceBlock(b, currentSbs);
                    continue;
                }
                ...
                // Access other chunk
                } else if (neighbourBlocks[3][jMinus + ijSize] === 0) {
                    addSurfaceBlock(b, currentSbs);
                    continue;
                }
                ...
                } else if (neighbourBlocks[4][kPlus - capacity] === 0) {
                    addSurfaceBlock(b, currentSbs);
                    continue;
                }
                ...
                } else if (neighbourBlocks[5][kMinus + capacity] === 0) {
                    addSurfaceBlock(b, currentSbs);
                    continue;
                }
