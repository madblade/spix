...
App.Engine.UI.prototype.registerTouch = function() {
    ...
    $(window).on('swipeleft', function(ev) {});
    $(window).on('swiperight', function(ev) {});
};

App.Engine.UI.prototype.unregisterTouch = function() {
